// Solve ATP Transport on Tissue Volume Using GPGPU Acceleration
#include <iostream>
#include <string>
#include <cuda.h>
#include "PDETools.h"
...
int main(int argc,char** argv)
{
  ...
  float q = 1.306e-1f; // blood vessel permeability <1/s>
  float Cb = 3.48e-7f; // blood concentration <M>
  float Vmax = 4.37e-8f; // maximal consumption <M/s>
  float Km = 1.43e-4f; // Michaelis-Menton Constant <M>
