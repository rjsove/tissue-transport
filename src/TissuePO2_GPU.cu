...
int main(int argc,char** argv)
{
  ...
  float VO2 = 0.75e-4f; // O2 consumption <mLO2/mL/s>
  ...
  float sim_time = 30.0f; // simulation time <s> was 360.0f
  if (argc == 2)
  ...
  //varIC(u_h,"out/PO2/steady_state_5.csv",N);
  constIC(u_h,1.0f,N);/*
