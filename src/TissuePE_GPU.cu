// Solve PE Transport on Tissue Volume Using GPGPU Acceleration
#include <iostream>
#include <string>
#include <cuda.h>
#include "PDETools.h"
...
int main(int argc,char** argv)
{
  ...
  float q = 2.334e-1f; // blood vessel permeability <1/s>
  float Cb = 0.0f; // blood concentration <M>
  float Vmax = 0.0f; // maximal consumption <M/s>
  float Km = 1.0f; // Michaelis-Menton Constant <M>
